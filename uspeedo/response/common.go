...
// it is only used for uspeedo open api v1 via HTTP GET and action parameters.
...
// GetRetCode will return the error code of uspeedo api
// Error is non-zero and success is zero
func (c *CommonBase) GetRetCode() int {
	return c.RetCode
}

// GetMessage will return the error message of uspeedo api
func (c *CommonBase) GetMessage() string {
	return c.Message
}

// GetAction will return the request action of uspeedo api
...
// SetRequest will set request of request
