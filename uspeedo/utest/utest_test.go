...
import (
	...
	"github.com/uspeedo/uspeedo-sdk-go/uspeedo/helpers/mock"
	"github.com/uspeedo/uspeedo-sdk-go/uspeedo/request"
	"github.com/uspeedo/uspeedo-sdk-go/uspeedo/response"
	"github.com/uspeedo/uspeedo-sdk-go/uspeedo/utest/driver"
	"github.com/uspeedo/uspeedo-sdk-go/uspeedo/utest/utils"
	"github.com/uspeedo/uspeedo-sdk-go/uspeedo/utest/validation"
	"os"
	"reflect"
	"testing"
)
...
func newMockedClient(mockData map[string]interface{}, mockError error) (*uspeedo.Client, error) {
	cfg := uspeedo.NewConfig()
	credential := auth.NewCredential()
	client := uspeedo.NewClient(&cfg, &credential)
