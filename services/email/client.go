...
// NewAction__sendEmailTemplateReq will create request of SendEmailTemplate action.
func (c *EmailClient) NewAction__sendEmailTemplateReq() *apis.Action__sendEmailTemplateReq {
    req := &apis.Action__sendEmailTemplateReq{}
...
*/
func (c *EmailClient) SendEmailTemplate(req *apis.Action__sendEmailTemplateReq) (*apis.Action__SendEmailTemplateResponse, error) {
    var err error
    var res apis.Action__SendEmailTemplateResponse
